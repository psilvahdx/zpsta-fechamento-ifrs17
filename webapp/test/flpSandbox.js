		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fechamento IFRS17",
									"targetURL": "#portosegurozpstafechifrs17app-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"portosegurozpstafechifrs17app-display": {
								"semanticObject": "portosegurozpstafechifrs17app",
								"action": "display",
								"description": "Aplicação Fiori para Fechamento IFRS17",
								"title": "Fechamento IFRS17",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=portoseguro.zpstafechifrs17app",
									"url": sap.ui.require.toUrl("portoseguro/zpstafechifrs17app")
								}
							}
						}
					}
